 ...
 */
var EasilyGtmService = /** @class */ (function () {
    /**
     * @ignore
     */
    function EasilyGtmService() {
     ...
     * @return {?}
     */
    EasilyGtmService.prototype.push = /**
     * Push values on dataLayer
     * @param {?} event reveive a GTM event
     * @param {?=} params receive all params, this object is optional
     * @return {?}
    ...
    /** @nocollapse */
    EasilyGtmService.ctorParameters = function () { return []; };
    /** @nocollapse */ EasilyGtmService.ngInjectableDef = defineInjectable({ factory: function SimpleGtmService_Factory() { return new EasilyGtmService(); }, token: EasilyGtmService, providedIn: "root" });
    return EasilyGtmService;
}());
...
export { EasilyGtmService, SimpleGtmComponent, SimpleGtmModule };

//# sourceMappingURL=easily-gtm.js.map
